...
# Index represents the rotation of the shape
shape_formats = [
    [['.....',
      '.....',
      '..O..',
...
def draw_grid(surface, grid):
    ...
    for y in range(len(grid)):
        for x in range(len(grid[y])):
            ...
            if grid[y][x] == (0, 0, 0):
                pygame.draw.rect(surface, (128, 128, 128), (sx + x * block_size, sy + y * block_size, block_size, block_size), 1)

    pygame.draw.rect(surface, (255, 0, 0), (sx, sy, play_width, play_height), 4)
...
shapes = [shape_formats[x] for x in range(len(shape_formats))]
